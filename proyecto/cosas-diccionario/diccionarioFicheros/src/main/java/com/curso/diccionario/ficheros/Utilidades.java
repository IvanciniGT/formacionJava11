...
public interface Utilidades {
    ...
    public static Optional<Map<String,List<String>>> cargarDiccionario(String idioma){
        ...
        if(!pathDelFichero.isEmpty())
            try{
                String contenido = Files.readString(pathDelFichero.get());                // JAVA 11
                
                Map<String,List<String>> resultado=contenido
                                .lines()                                            // JAVA 11: Tomando cada linea del fichero para trabajar con ella
                                                                                    // Parte por \n \r \n\r
                                ...
                                .filter(    linea -> linea.indexOf("=") != -1   )   // JAVA 11: solo proceso lineas con el signo igual !
    ...
    public static Optional<Path> getRutaDiccionario(String idioma){
        try{
            ...
            System.err.println("Problema al recuperar URI del diccionario");
        }
        return Optional.empty();
